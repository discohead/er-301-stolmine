...
|   | `control-shift-subdisplay-indicator` | Detect controls with an extra SHIFT sub-display and surface a discoverability indicator | manual · 2026-07-20 |
...
|   | `promote-control-to-top-level` | Promote an inner control to its container's top-level control interface (one action) | manual · 2026-07-15 |
